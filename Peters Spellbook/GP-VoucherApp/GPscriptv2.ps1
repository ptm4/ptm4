...
$logFolder = Join-Path $env:LOCALAPPDATA "SHC\VoucherApp"
if (-not (Test-Path $logFolder)) { New-Item -Path $logFolder -ItemType Directory -Force | Out-Null }
$logFile = Join-Path $logFolder "GPscript_Audit.log"
...
$buttonRun2.Text = 'Put On Hold'
$buttonRun2.Location = New-Object System.Drawing.Point(420,120)
$buttonRun2.Size = New-Object System.Drawing.Size(120,40)
$form.Controls.Add($buttonRun2)
...
$buttonRun2.Add_Click({
    ...
    try {
        ...
        foreach ($voucherNumber in $vouchers) {
            ...
            try {
                $query = "UPDATE PM20000 SET HOLD = 1 WHERE VCHRNMBR = @voucherNumber"
                $command = $connection.CreateCommand()
                $command.CommandText = $query
                $command.Parameters.Add("@voucherNumber",[System.Data.SqlDbType]::VarChar,20).Value = $voucherNumber
