    ...
    },
    {
        ...
        "steps": [
            ...
            ("e-ws-github", "git push to main",
             "Pushing paths under homelab/RPI-srv/** is what triggers the deploy workflow."),
...
NETWORK = {
    ...
    "records": [
        ...
        {"name": "noblenumbat.lan", "ip": "192.168.1.6"},
        {"name": "jellyfin.lan", "ip": "192.168.1.6"},
        {"name": "comics.lan", "ip": "192.168.1.6"},
