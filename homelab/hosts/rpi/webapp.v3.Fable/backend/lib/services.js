...
// the rpi and noblenumbat compose files, nginx-wg.conf. URLs use Pi-hole DNS names
...
const SERVICES = [
  ...
  { id: 'pihole', label: 'Pi-hole', url: 'http://rpi.lan/admin', icon: 'pi-hole.svg', category: 'Infrastructure', host: 'rpi', container: 'pihole', probe: 'http://rpi.lan', fav: true, description: 'LAN DNS + DHCP', internalPage: '/pihole' },
  ...
  { id: 'uptime-kuma', label: 'Uptime Kuma', url: 'http://rpi.lan:3001/', icon: 'uptime-kuma.svg', category: 'Infrastructure', host: 'rpi', container: 'uptime-kuma', probe: 'http://rpi.lan:3001', fav: true, description: 'Synthetic monitors' },
  { id: 'dozzle', label: 'Dozzle (logs)', url: '/dozzle/', icon: 'dozzle.svg', category: 'Infrastructure', host: 'rpi', container: 'dozzle', fav: true, description: 'Live container logs, all hosts', internalPage: '/logs' },
  ...
  { id: 'vaultwarden', label: 'Vaultwarden', url: 'https://bitwarden.rpi.lan/#/vault', icon: 'vaultwarden.svg', category: 'Infrastructure', host: 'rpi', container: 'bitwarden', probe: 'https://bitwarden.rpi.lan', fav: true, description: 'Password manager' },
  { id: 'vaultwarden-admin', label: 'Vaultwarden admin', url: 'https://bitwarden.rpi.lan/admin/users/overview', icon: 'vaultwarden.svg', category: 'Infrastructure', host: 'rpi', container: 'bitwarden', probe: 'https://bitwarden.rpi.lan', description: 'Users & server settings' },
  ...
  // ── this dashboard ──────────────────────────────────────────────────────────
  { id: 'architecture', label: 'Architecture map', url: '/architecture/', icon: 'generic.svg', category: 'Dashboard', host: 'rpi', internal: true, description: 'Curated + live architecture graph' },
  { id: 'agents', label: 'Agents', url: '/agents/', icon: 'generic.svg', category: 'Dashboard', host: 'rpi', internal: true, description: 'Per-host arch agents' },
  ...
  { id: 'notes', label: 'Notes', url: '/notes/', icon: 'generic.svg', category: 'Dashboard', host: 'rpi', container: 'notes-api', internal: true, description: 'Notes app' },
  { id: 'agentic', label: 'Agentic workspace', url: '/agentic/', icon: 'generic.svg', category: 'Dashboard', host: 'rpi', internal: true, description: 'Skills, rules, runbooks' },
  { id: 'legacy', label: 'Legacy UI (v1)', url: '/legacy/', icon: 'generic.svg', category: 'Dashboard', host: 'rpi', internal: true, description: 'The pre-redesign dashboard' },
];
