...
work dir differs (default: `~/actions-runner/_work/ptm4/ptm4/homelab/hosts/opti`), then:

```bash
sudo cp homelab/hosts/opti/systemd/hl-agent-dispatcher.service /etc/systemd/system/
...
python3 homelab/tools/collectors/network-report.py
