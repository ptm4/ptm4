// The bookmark catalog — port of v2's lib/links.ts (vendored selfhst/homarr
// dashboard-icons, Apache-2.0 — LICENSE alongside the SVGs under static/icons/apps/).
...
export const LINK_GROUPS: LinkGroup[] = [
  { group: 'Infrastructure', links: [
    ...
    { label: 'Uptime Kuma', url: 'http://noblenumbat.lan:3001/', icon: 'uptime-kuma.svg', fav: true },
