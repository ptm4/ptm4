...
const SERVICES = [
  ...
  { id: 'uptime-kuma', label: 'Uptime Kuma', url: 'http://noblenumbat.lan:3001/', icon: 'uptime-kuma.svg', category: 'Infrastructure', host: 'noblenumbat', container: 'uptime-kuma', probe: 'http://noblenumbat.lan:3001', fav: true, description: 'Synthetic monitors' },
