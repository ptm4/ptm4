...
| **v3 rewrites** | `webapp.v3.Fable/` and `webapp.v3.Astra/` sit beside it — side-by-side work, **not deployed** by CI until go-live; coordination in `AgentComms.md` at the repo root |
